...
/**
 * FileClassLoader extends URLClassLoader to provide functionality for loading a
 * class from a file or byte array.
 * 
 * @author Darryl
 * @see URLClassLoader
 */
public class FileClassLoader extends URLClassLoader {
	 ...
	 * specified delegation parent ClassLoader. The URLs will be searched in the
	 ...
	 * resources. Overrides the super method to provide public access.
	 * 
	 * @param url
	...
	/**
	 * Converts a file into an instance of class Class and resolves the Class so
	 * it can be used. This method extracts the file content as a byte array and
	 * invokes createClass(byte[]).
	 * <P>
	 * The file content should have the format of a valid class file as defined
	 * by the <a href="http://java.sun.com/docs/books/vmspec/"> Java Virtual
	 ...
	 * <P>
	 * The byte array should have the format of a valid class file as defined by
